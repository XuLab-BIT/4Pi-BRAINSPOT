    ...
    methods
        ...
        function Perform_DriftCorrection3D(obj)
            ...
            for ss=1:1:numel(unistack)
                ...
                % add new parameters
                obj.loc_photons_f{ss} = obj.loc_photons(maskst);
                obj.loc_bg_f{ss} = obj.loc_bg(maskst);
                obj.loc_crlb_f{ss} = obj.loc_crlb(maskst,:);
            end
        end
        ...
        function Perform_stackalignment(obj)
            ...
            if numel(obj.loc_x_f)==1
                ...
                % add new parameters
                obj.loc_t_f = obj.loc_t_f{1};
                obj.loc_cycle_f = obj.loc_cycle_f{1};
                obj.loc_step_f = obj.loc_step_f{1};
                obj.loc_photons_f = obj.loc_photons_f{1};
                obj.loc_bg_f = obj.loc_bg_f{1};
                obj.loc_crlb_f = obj.loc_crlb_f{1};
            elseif numel(obj.loc_x_f)>1
                ...
                % add new parameters
                obj.loc_t_f = cat(1,obj.loc_t_f{:});
                obj.loc_cycle_f = cat(1,obj.loc_cycle_f{:});
                obj.loc_step_f = cat(1,obj.loc_step_f{:});
                obj.loc_photons_f = cat(1,obj.loc_photons_f{:});
                obj.loc_bg_f = cat(1,obj.loc_bg_f{:});
                obj.loc_crlb_f = cat(1,obj.loc_crlb_f{:});
            else
